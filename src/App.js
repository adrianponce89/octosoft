        ...
        <Router>
            <ThemeProvider theme={theme}>
                ...
                <Switch>
                    ...
                    <Route path={"/assistance"}> <Service service={SERVICES.assistance}/> </Route>
                    <Route path={"/design"}> <Service service={SERVICES.design}/> </Route>
                    <Route path={"/development"}> <Service service={SERVICES.development}/> </Route>
                    <Route path={"/education"}> <Service service={SERVICES.education}/> </Route>
